...
const HomeIndicators = () => {
  ...
  return (
    <>
      {/* Numbers Section */}
      <div className="container-fluid py-5" style={{backgroundColor:"papayawhip"}}>
        <div className="container">
          <div className="row text-center">
            <div className="col-12 col-md-4">
              <div className="d-flex justify-content-center">
                <p id="travellers" className="fw-bold fs-1 number">0</p>
            ...
            <div className="col-12 col-md-4">
              <div className='d-flex justify-content-center'>
                <p id="destinations" className="fw-bold fs-1 number">0</p>
                <p className='fw-bold fs-1'>K+</p>
              </div>
            ...
            <div className="col-12 col-md-4">
              <div className='d-flex justify-content-center'>
                <p id="rate" className="fw-bold fs-1 number">0</p>
