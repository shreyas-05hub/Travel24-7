      ...
      <div className="container">
        <div className="row">
          <div className="col-md-3 col-sm-6 mb-4">
            <h5 className="text-uppercase mb-4 fw-bold text-primary">Explore</h5>
            <ul className="list-unstyled">
              <li><Link to="/packages" className="text-white text-decoration-none">Travel Packages</Link></li>
              <li><Link to="/destinations" className="text-white text-decoration-none">Destinations</Link></li>
              <li><Link to="/about" className="text-white text-decoration-none">About Us</Link></li>
              <li><Link to="/faq" className="text-white text-decoration-none">FAQ</Link></li>
            </ul>
          </div>
          <div className="col-md-5 col-sm-6 mb-4">
            <h5 className="text-uppercase mb-4 fw-bold text-primary">Get In Touch</h5>
            <p><i className="fas fa-map-marker-alt me-3"></i> 123 Travel Lane, Adventure City</p>
            <p><i className="fas fa-phone me-3"></i> +1 (555) 123-4567</p>
            <p>
              <i className="fas fa-envelope me-3"></i> 
              <a className="text-white text-decoration-none">info@travelsite.com</a>
            </p>
          </div>
        ...
        <div className="row align-items-center">
          ...
          <div className="col-md-6 col-lg-4 text-md-end text-center">
            ...
            | 
            <Link to="/terms" className="text-white text-decoration-none ms-3">Terms of Service</Link>
          </div>
        </div>
      </div>
    </footer>
